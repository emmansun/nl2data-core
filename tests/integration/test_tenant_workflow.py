"""Integration tests for multi-entity tenant scope boundaries.

Proves that a missing or mismatched tenant scope rejects multi-entity planning
...
@pytest.mark.asyncio
async def test_missing_tenant_scope_rejects_multi_entity_before_adapter(
    tmp_path: Path,
) -> None:
    """Multi-entity planning requires a valid tenant scope at runtime."""
