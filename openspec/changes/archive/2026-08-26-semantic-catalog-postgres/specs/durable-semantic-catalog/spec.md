...
The catalog SHALL write only bounded canonical envelopes with explicit schema and artifact kind, reject unsupported versions or unsafe payloads, and revalidate fingerprints, source compatibility, and tenant/source scope on read.
