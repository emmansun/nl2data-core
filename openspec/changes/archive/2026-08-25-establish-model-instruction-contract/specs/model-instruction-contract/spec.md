...
Instruction bundles SHALL reject credentials, connection strings, raw SQL/MQL, executable code, native objects, raw tenant/principal claims, hidden policy material, and unbounded text or section counts. User prompt content SHALL remain separate from system instructions.
