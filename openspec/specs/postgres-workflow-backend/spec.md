# postgres-workflow-backend Specification

## Purpose
Define an independently installable PostgreSQL backend for durable workflow state, idempotency records, leases, and fencing, implementing the core state-store contracts with lazy psycopg loading, tenant-scope isolation, and normalized errors.
