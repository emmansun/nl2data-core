...
The runtime SHALL expose ordered stages for memory, intent, IR building, IR validation, governance, authorization, execution, protection, persistence, and completion, and SHALL reject execution when a required prior gate is missing or stale.
