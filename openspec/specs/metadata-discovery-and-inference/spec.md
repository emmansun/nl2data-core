...
The system SHALL compare compatible metadata snapshots by canonical identity and report bounded safe added, removed, and changed object/field/constraint references. Canonical serialization SHALL be independent of object-internal and provenance evidence iteration order. Bundle/View/IR consumers SHALL reject stale snapshot references when required compatibility fingerprints no longer match.
