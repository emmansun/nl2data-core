...
class MongoAdapterConfig(BaseModel):
    """Configuration for one MongoDB adapter instance.

    The URI is an internal configuration secret: it never appears in
    fingerprints, details, or public records.
    """
    ...
    required_obligation_fingerprint: str | None = Field(
