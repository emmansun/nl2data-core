...
class ErrorCode(StrEnum):
    ...
    JOIN_PATH_NOT_FOUND = "JOIN_PATH_NOT_FOUND"
    JOIN_PATH_AMBIGUOUS = "JOIN_PATH_AMBIGUOUS"
    JOIN_EDGE_UNAUTHORIZED = "JOIN_EDGE_UNAUTHORIZED"
    MULTI_ENTITY_UNSUPPORTED = "MULTI_ENTITY_UNSUPPORTED"
    CALCULATED_FIELD_REJECTED = "CF_001"
    CALCULATED_FIELD_REFERENCE_INVALID = "CF_002"
    CALCULATED_FIELD_REFERENCE_UNKNOWN = "CF_003"
    CALCULATED_FIELD_MASKED_REFERENCE = "CF_004"
    CALCULATED_FIELD_ZERO_DIVISION = "CF_005"
