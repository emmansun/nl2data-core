...
| [Guides](guides/composition-and-query-lifecycle.md) | Application integrators composing the library | Getting started | [Composition and query lifecycle](guides/composition-and-query-lifecycle.md) |
...
- **New user**: [Installation](getting-started/installation.md) → [Quickstart](getting-started/quickstart.md) → [Composition and query lifecycle](guides/composition-and-query-lifecycle.md)
